...
export const COL_ROOMS = process.env.NEXT_PUBLIC_APPWRITE_ROOMS_COLLECTION_ID || "";
export const COL_MESSAGES = process.env.NEXT_PUBLIC_APPWRITE_MESSAGES_COLLECTION_ID || "";
